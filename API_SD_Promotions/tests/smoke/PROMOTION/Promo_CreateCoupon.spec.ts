...
import { create_Coupon, create_CouponCriteria, create_CouponPrizeType, create_CouponText, update_CouponCommit, delete_CouponPromo, read_AllPromotions } from '../../../lib/PROMOTION/Coupon';
...
describe('·Navigator (Promotions Manager => Coupon Promotion => Create a coupon Promotion - status commit)', () => {
    beforeEach(() => {
    ...
    it(a.getname(193, envSettings.envname, true), async () => {
       ...
       // console.log(getAllPromoData);
        ...
        if (promoid == undefined || promoid == null) {
            pending("Not able to Commit Coupon");
        }
